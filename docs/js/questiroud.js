...
// Code configuration
var JSON_URL = "http://krs-lk.osobnikouzlo.cz/questions.php";
var TARGET_POST_URL = "http://krs-lk.osobnikouzlo.cz/";

// Text parts
var NEXT_BUTTON_TEXT = "DALŠÍ";
var SUBMIT_BUTTON_TEXT = "ODESLAT";
var PLACEHOLDER_EMAIL = "Váš email";
var PLACEHOLDER_NAME = "Vaše jméno a příjmení";
var SENDING_STATUS = "Právě odesíláme vaše výsledky, prosím počkejte!";
var ERROR_MESSAGE_FOR_QUOTATION_MARKS_IN_NAME = "Jméno ani email nesmí obsahovat znak uvozovky či apostrofu.";
var NOT_ALL_REQUIRED_QUESTIONS_ANSWERED = "Všechny otázky musí být zodpovězené!";
            ...
            $.post(
                ...
                function(response) {
                    ...
                    if (response.hasOwnProperty('responseJSON')) {
                        ...
                        render_response_wrong(response);
                    }
                }
            )
        }
